      ...
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            ...
            paragraph="Have questions about herbs or how our AI works? Herb AI is here to help you learn and explore. From understanding plant benefits to using the prediction tool, we make it easy for you to get accurate information and support whenever you need it."
            center
            mb="80px"
          />
        </div>
