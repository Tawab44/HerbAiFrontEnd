            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  10 Amazing Benefits of Using Herbs Over Modern Medicine
                </h2>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Herbal remedies have been trusted for centuries, offering a natural alternative to synthetic drugs. They often come with fewer side effects and are generally safer for long-term use. Herbs like Tulsi, Mint, and Ashwagandha boost immunity, improve digestion, and support overall well-being naturally.
                  </p>
                  <div className="mb-10 w-full overflow-hidden rounded-sm">
                    <div className="relative aspect-97/60 w-full sm:aspect-97/44">
                      <Image
                        src="/images/blog/blogdetails1.jpg"
                        alt="image"
                        fill
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Unlike modern medicine, which may focus on treating symptoms, herbs help address the root cause of many health issues, promoting balance in the body. They are also cost-effective, easily available, and can be grown at home for fresh use.

Using herbs can help reduce dependency on chemical-based medicines and contribute to a healthier lifestyle. Whether it’s calming stress with Chamomile, improving focus with Brahmi, or detoxifying with Neem, herbal solutions provide a holistic approach to wellness.
                  ...
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    ...
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Promote better digestion and detoxification
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                  ...
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                     Using herbs can help reduce dependency on chemical-based medicines and contribute to a healthier, more sustainable lifestyle. Whether it’s calming stress with Chamomile, improving focus with Brahmi, or detoxifying with Neem, herbal solutions provide a holistic approach to wellness.
                    </p>
                  ...
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Additionally, many herbs provide multiple benefits at once — for example, Turmeric reduces inflammation, improves digestion, and supports immunity all in one. This multi-purpose nature makes them a powerful tool in maintaining a healthy lifestyle.
                  </p>
