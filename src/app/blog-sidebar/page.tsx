            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  Which Herbs to Use for Common Symptoms?
                </h1>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Nature has given us a wide variety of herbs that can be used to manage everyday health issues safely and naturally. Choosing the right herb for your symptom can save you from unnecessary medication and side effects while promoting overall wellness.
                  </p>
                  <div className="mb-10 w-full overflow-hidden rounded-sm">
                    <div className="relative aspect-97/60 w-full sm:aspect-97/44">
                      <Image
                        src="/images/blog/herbdetails2.jpg"
                        alt="image"
                        fill
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    If you struggle with stress or anxiety, herbs like Ashwagandha, Chamomile, and Lavender are excellent for calming the mind and improving sleep. For digestive issues, consider Mint, Fennel, and Ginger, which help reduce bloating and improve gut health.When dealing with
                    <strong className="text-primary dark:text-white">
                      {" "}
                      colds or low immunity{" "}
                    </strong>
                    ulsi, Turmeric, and Echinacea work wonders by boosting immune response and fighting infections. For fatigue and weakness, Ginseng and Moringa provide a natural energy boost and improve focus.
                  </p>
                  ...
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Stress & Anxiety – Ashwagandha, Chamomile, Lavender
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Poor Digestion – Mint, Fennel, Ginger
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Low Immunity – Tulsi, Turmeric, Echinacea
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Fatigue – Ginseng, Moringa
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Skin Problems – Aloe Vera, Neem, Calendula
                    </li>
                  </ul>
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                     The best part about using herbs is that they can be incorporated into your daily routine easily — as teas, powders, or fresh leaves in meals. This makes them a simple, sustainable, and holistic way to maintain health without over-reliance on chemical medicines.
                    </p>
                  ...
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    For those who suffer from headaches or migraines, Peppermint and Feverfew are well-known for their ability to relieve pain and improve circulation.
                  </p>
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <ul className="p-8">
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <RelatedPost
                      title="Herbs vs. Pills: Why Going Natural Can Be the Healthier Choice."
                      image="/images/blog/herbp1.jpg"
                      slug="#"
                      date="12 Sep 2025"
                    />
                  </li>
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <RelatedPost
                      title="From Kitchen to Cure: How Common Herbs Heal Naturally."
                      image="/images/blog/herbp2.jpg"
                      slug="#"
                      date="13 Sep 2025"
                    />
                  </li>
                  <li>
                    <RelatedPost
                      title="5 Everyday Herbs That Can Transform Your Health."
                      image="/images/blog/herbp3.jpg"
                      slug="#"
                      date="14 Sep 2025"
                    />
                  </li>
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <div className="flex flex-wrap px-8 py-6">
                  <TagButton text="Benefits" />
                  <TagButton text="Herbs" />
                  <TagButton text="Healthy" />
                  <TagButton text="Tips" />
                  <TagButton text="Multi-Purpose" />
                </div>
              </div>
